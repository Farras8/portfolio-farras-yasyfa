...
export const projects: ProjectData[] = [
  ...
  },
  {
    ...
    description:
      'King Culinary is a food recipe sharing platform where users can explore, upload, and bookmark various culinary creations, built using HTML, CSS, and JavaScript.',
    longDescription:
      'King Culinary is a front-end web application designed for food enthusiasts to discover and share their favorite recipes. Built using HTML, CSS, and JavaScript, the platform allows users to browse a collection of community-submitted recipes, upload their own creations, bookmark favorites for later, and manage their personal profiles with full CRUD functionality. As a solo project, it was developed with a focus on clean UI, responsive design, and smooth user interactions to enhance the recipe discovery experience.',
    technologies: ['HTML', 'CSS', 'JavaScript', 'Vercel'],
    features: [
      'Browse and view recipes shared by other users',
      'Upload personal recipes with details and images',
      'Bookmark favorite recipes for later viewing',
      'Full CRUD functionality for user profile management',
      'Responsive and interactive front-end experience',
    ],
    myJobDesk: [
      'Designed and developed the entire front-end using HTML, CSS, and JavaScript',
      'Implemented recipe upload, view, and bookmark functionality',
      'Developed user profile management with full CRUD capabilities',
      'Handled UI/UX design and deployed the website to Vercel',
    ],
    images: [
    ...
    client: 'ShopEasy Inc.',
    status: 'In Progress',
    liveUrl: 'https://king-culinary.vercel.app/',
    codeUrl: 'https://github.com/Farras8/King-Culinary.git',
    rank: 'A-Rank',
