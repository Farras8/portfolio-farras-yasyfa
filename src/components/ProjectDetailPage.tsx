    ...
    <>
      <AnimatedSection id="project-detail" className="bg-gray-900">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          ...
          {/* Maintenance Alert */}
          {project.status === 'Maintenance' && project.maintenanceMessage && (
            <div className="mb-6 sm:mb-8 mx-auto max-w-4xl">
              <div className="bg-gradient-to-r from-yellow-900/80 to-orange-900/80 border-l-4 border-yellow-500 p-4 sm:p-6 rounded-lg backdrop-blur-sm">
                <div className="flex items-center">
                  ...
                  <div className="ml-3 sm:ml-4">
                    <h3 className="text-sm sm:text-base font-medium text-yellow-300">
                      Project Sedang Maintenance
                    </h3>
                    <p className="mt-1 sm:mt-2 text-xs sm:text-sm text-yellow-200">
